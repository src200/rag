...
function BackgroundGridPattern() {
  return (
    <svg
      className="absolute inset-0 -z-10 h-full w-full stroke-neutral-500/10 [mask-image:radial-gradient(100%_100%_at_top_right,white,transparent)]"
      aria-hidden="true"
    >
      <defs>
        <pattern
      ...
      <svg
        x="50%"
        y={-1}
        className="overflow-visible fill-neutral-200/10 dark:fill-neutral-800/10"
      >
        <path
